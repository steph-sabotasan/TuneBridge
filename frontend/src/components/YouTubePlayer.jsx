 ...
 * 
 * YouTube Brand Compliance: This component embeds the official YouTube IFrame Player.
 * Per YouTube API Terms of Service, we use the official embed player which provides
 * proper YouTube branding within the player itself.
 */
