          ...
          */}
          <div className="bg-white rounded-lg shadow-xl p-6 mb-6">
            <div className="flex items-start justify-between gap-6">
              ...
              {/* Convert Button - Using purple theme, NOT YouTube red */}
              <div className="flex-shrink-0">
                <button
                  onClick={handleConvertToYouTube}
                  disabled={converting}
                  className="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-200 flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-105 disabled:hover:scale-100"
                >
                  {converting ? (
                    <>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="text-lg">Find on</div>
